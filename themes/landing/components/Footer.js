                ...
                <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
                    ...
                    <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
                        ...
                        <ul className="text-sm">
                            ...
                            <li className="mb-2">
                                <a href="https://blog.yangfeiyue.bot.cd/" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">博客</a>
                            </li>
                            <li className="mb-2">
                                <a href="" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out"></a>
                            </li>
                    ...
                    <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
                        <li>
                          <div className='h-full flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100'>
                             Powered by<a href='https://blog.yangfeiyue.bot.cd/' className='mx-1 hover:underline font-semibold'>NotionNext {siteConfig('VERSION')}</a>
                          </div>
                        </li>
                        {/* <li>
