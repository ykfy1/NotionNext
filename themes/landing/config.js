const CONFIG = {
  ...
  LANDING_HEADER_BUTTON_2_URL: 'https://blog.yangfeiyue.bot.cd/?theme=hexo',
  ...
  LANDING_POST_REDIRECT_URL: process.env.NEXT_PUBLIC_POST_REDIRECT_URL || 'https://blog.yangfeiyue.bot.cd/?theme=hexo', // 重定向网站地址
